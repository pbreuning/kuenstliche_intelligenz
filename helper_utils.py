...
def plot_results(model, distances, times):
    ...
    plt.plot(distances.numpy(), times.numpy(), color='orange', marker='o', linestyle='None', label='Tatsächlicher Preis')
    
    # Plot the predicted line from the model
    plt.plot(distances.numpy(), predicted_times.numpy(), color='green', marker='None', label='Vorhergesagter Preis')
    
    # Set the title of the plot
    plt.title('Tatsächliche vs vorhergesagte Zeiten')
